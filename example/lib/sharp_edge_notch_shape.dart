...
class CircularSharpEdgeNotchedRectangle extends NotchedShape {
  /// Creates a [CircularNotchedRectangle].
  ///
  /// The same object can be used to create multiple shapes.
  const CircularSharpEdgeNotchedRectangle();
  ...
  Path getOuterPath(Rect host, Rect? guest) {
    ...
    final double notchRadius = guest.width / 2.25;
